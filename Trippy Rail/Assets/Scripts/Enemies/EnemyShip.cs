...
public class EnemyShip : MonoBehaviour {
	...
	void Update() {
		...
		if (menuInter != null && aimanagerScript.player!=null) {
	...
	void OnTriggerEnter(Collider other){
		//		Debug.Log (other.tag);
		if (other.CompareTag("PlayerBullet1")) {
	...
	void Kill() {
		...
		if (playerShip!=null) {// was firstDeath && playership.transform.position!=null
